    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        if detections is not None:
            ...
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                ...
                print("type:", type(cls_conf.item()))
                print("type:", type(classes[int(cls_pred)]))
                print("type:", type(x2.numpy()))
                Dictionary["bbox"].append((round(y1.item()), round(x1.item()), round(y2.item()), round(x2.item())))
                Dictionary["score"].append(cls_conf.item())
                Dictionary["label"].append(int(classes[int(cls_pred)]))
